 ...
 * 
 * Function requires FinalValue(array), Threshold(int), and sEMGfinal(bool) to be defined before calling function
...
//Here the booleans are added to the array - They have to be added on at a time
